...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/courroie.jpg)">
...
$sql = "SELECT p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 203 AND p.code_type = 310 AND i.nom IS NOT NULL AND i.nom <> ''
        ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
                <div class="image">
                    <img id='photo_prod'  src="images/courroie/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								<article class="post">
									...
									<div class="text"><a href="fuelfilter">fltre à huile</a></div>
