...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url('images/background/gasoil.jpg');">
        <div class="auto-container">
			<div class="inner-container clearfix">
			<!-- <h5> </h5> -->
                <div class="pull-right">
					<ul class="bread-crumb clearfix">
						<li><a href="">Fitre à gasoil</a></li>
						<!-- <li>Shop</li> -->
					</ul>
    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
        	<div class="row clearfix">
				<!--Content Side-->
                <div class="content-side col-lg-8 col-md-4 col-sm-19">
...
$sql = "SELECT p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 201 AND p.code_type = 302
        ";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="inner-box">
                ...
                <div class="image">
                    <img id='photo_prod'  src="images/filtreagasoil/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
				...
				<?php echo $nom_produit; ?> <h3><a href="produit.php?id=<?php echo $id?>"><?php echo $reference; ?></a></h3>
                <div class="clearfix">
                        <div class="pull-left">
                ...
                <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                	<aside class="sidebar">
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-">
								<article class="post">
									<figure class="post-thumb"><img src="images/resource/1.jpg" alt="airfilter.php"><a href="" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="airfilter.php">filtre à air</a></div>
									<div class="post-info">voir plus</div>
								</article>

								<article class="post">
									<figure class="post-thumb"><img src="images/resource/ras.jpg" alt=""><a href="filtrehydraulique.php" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="filtrehydraulique.php">filtre a hydraulique</a></div>
									<div class="post-info">voir plus</div>
								</article>

								<article class="post">
									<figure class="post-thumb"><img src="images/resource/2.jpg" alt=""><a href="huile.php" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="huile.php">huile moteur.</a></div>
									<div class="post-info">voir plus</div>
								</article>
							</div>
