...
<title>liquide de refroidissement</title>
<style>
	#photo_prod
	{
		height: 200px;
...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/liquide.jpg)">
...
$sql = "SELECT p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 202 AND p.code_type = 309
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
                <div class="image">
                    <img id='photo_prod'  src="images/liquide/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
                    <div class="overlay-box">
                        <ul class="cart-option">
                            <li><a href="produit.php?id=<?php echo $id?>"><span class="fa fa-shopping-cart"></span></a></li>
                        </ul>
                    </div>
                </div>
                	...
                	<aside class="sidebar">
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								<article class="post">
									<figure class="post-thumb"><img src="images/resource/1.jpg" alt=""><a href="fuelfilter.php" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="fuelfilter.php">filtre à huile</a></div>
									<div class="post-info"></div>
								</article>

								<article class="post">
									<figure class="post-thumb"><img src="images/resource/4.jpg" alt=""><a href="fuelfilter.php" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="fuelfilter.php">filtre à gasoil</a></div>
									<div class="post-info"></div>
								</article>

								<article class="post">
									<figure class="post-thumb"><img src="images/resource/3.jpg" alt=""><a href="airfilter.php" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
