...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/air1.jpg)">
    ...
    <?php
		...
		$sql = "SELECT p.*, i.nom AS nom_image
				...
				WHERE p.code_categorie = 201 AND p.code_type = 301
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				...
				// $queryStock = "SELECT stock FROM produits WHERE code_type IN (301, 302, 303, 304, 305)";
				// $result = $conn->query($queryStock);
				
				// while ($row = $result->fetch_assoc()) {
				// 	echo "Stock pour le produit : " . $row['stock'] . "<br>";
				// }
...
?>               
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="inner-box">
				<a href="produit.?id=<?php echo $id ?>">
                <div class="image">
                    <img id='photo_prod'  src="images/filtreair/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
                	...
                	<aside class="sidebar">
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								<article class="post">
									<figure class="post-thumb"><img src="images/resource/1.jpg" alt=""><a href="airfilter" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="filtreahuile">fitre à huile</a></div>
									<div class="text"><a href="filtreahuile">Voir plus </a> </div>
								</article>

								<article class="post">
									<figure class="post-thumb"><img src="images/resource/ras.jpg" alt=""><a href="fuelfilter" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="fuelfilter">filtre à gazoil</a></div>
									<div class="post-info">Voir plus</div>
								</article>

								<article class="post">
									<figure class="post-thumb"><img src="images/resource/2.jpg" alt=""><a href="huile" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
