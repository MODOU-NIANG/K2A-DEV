...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/col.jpg)">
...
$sql = "SELECT p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 203 AND p.code_type = 311 AND i.nom IS NOT NULL AND i.nom <> ''
        ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
                <div class="image">
                    <img id='photo_prod'  src="images/colle/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
						...
						<!-- <div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								<article class="post">
									...
									<div class="text"><a href="filtreahuile">filtre à huile</a></div>
								...
								<article class="post">
									...
									<div class="text"><a href="huile">huile à moteur</a></div>
									<div class="post-info"></div>
								</article>
