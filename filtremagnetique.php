...
$sql = "SELECT p.reference, p.nom_produit,p.prix, i.nom AS nom_image
        FROM produits p
        JOIN images i ON p.code_produit = i.code_produit
        WHERE p.code_categorie = 201 AND p.code_type = 306
    ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
                <div class="image">
                    <img id='photo_prod'  src="images/filtremagnetique/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
                    <div class="overlay-box">
                        <ul class="cart-option">
                            <li><a href="shop-single.html"><span class="fa fa-shopping-cart"></span></a></li>
                        </ul>
                    </div>
                </div>
                <div class="lower-content">
				<?php echo $nom_produit; ?> <h3><a href="shop-single.html"><?php echo $reference; ?></a></h3>
                <div class="clearfix">
                        <div class="pull-left">
                            <div class="price"><?php echo $prix; ?></div> <!-- Remplacez par le prix dynamique si disponible -->
                        </div>
                        <div class="pull-right">
                            <!--Rating-->
                            <div class="rating">
                	...
                	<aside class="sidebar">
						...
						<div class="sidebar-widget categories-widget">
							...
							<div class="widget-content">
								<ul class="blog-cat">
									<li><a href="#">Filtres <span>04</span></a></li>
									<li><a href="#">Lubrifiants <span>06</span></a></li>
									<li><a href="#">Accessoires et Divers<span>01</span></a></li>
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								<article class="post">
									...
									<div class="text"><a href="blog-detail.html">Best factory award of the year 2018</a></div>
									<div class="post-info">Views 250</div>
								</article>
								...
								<article class="post">
									...
									<div class="text"><a href="blog-detail.html">Materials for the carbohy-drate ecnomy</a></div>
								...
								<article class="post">
									...
									<div class="text"><a href="blog-detail.html">We have a great work team & environment.</a></div>
				...
				<div class="row clearfix">
					...
					<div class="title-column col-lg-5 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<!-- <div class="text">En cas de besoin, Contactez-nous. : <span>(325) 512-9895</span></div> -->
						</div>
					</div>
					<!-- Form Column -->
					<div class="form-column col-lg-7 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="subscribe-form">
								<form method="post" action="contact.html">
									<div class="form-group">
										<input type="email" name="email" value="" placeholder="Votre adresse mail" required>
										<button type="submit" class="theme-btn submit-btn">S'inscrire</button>
									</div>
								</form>
							</div>
						</div>
