...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/direction.jpg)">
...
$sql = "SELECT p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 203 AND p.code_type = 313 AND i.nom IS NOT NULL AND i.nom <> ''
        ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
                <div class="image">
                    <img id='photo_prod'  src="images/protegedirection/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
                	...
                	<aside class="sidebar">
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								<article class="post">
									<figure class="post-thumb"><img src="images/resource/1.jpg" alt=""><a href="fuelfilter" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="fuelfilter">filtre à huile</a></div>
								...
								<article class="post">
									<figure class="post-thumb"><img src="images/resource/3.jpg" alt=""><a href="fuelfilter" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="fuelfilter">filtre à air</a></div>
									<div class="post-info"></div>
								</article>
							</div>
