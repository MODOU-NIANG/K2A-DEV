...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/huile.jpg);">
...
$sql = "SELECT p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 202 AND p.code_type = 307
        ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="shop-item col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
                <div class="image">
                    <img id='photo_prod'  src="images/huile/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
...
// $filtres = "SELECT * FROM produits WHERE code_type IN (301,302,303,304,305)";
// $result_filtres = $conn->query($filtres);

// $lubrifiants = "SELECT * FROM produits WHERE code_type IN (307,308)";
// $result_lubrifiants = $conn->query($lubrifiants);

// $accessoires = "SELECT * FROM produits where code_type in (309,310,311,312,313)";
// $result_accessoires = $conn->query($accessoires);
                	...
                	<aside class="sidebar">
						...
						<div class="sidebar-widget popular-posts">
							...
							<div class="widget-content">
								...
								<article class="post">
									<figure class="post-thumb"><img src="images/resource/1.jpg" alt=""><a href="filtreahuile" class="overlay-box"><span class="icon fa fa-link"></span></a></figure>
									<div class="text"><a href="fitreahuile">filtre à huile</a></div>
								...
								<article class="post">
									...
									<div class="text"><a href="fuelfilter.">filtre à gasoil.</a></div>
									<div class="post-info"></div>
								</article>
							</div>
