...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/fuel.jpg)">
			...
			<div class="inner-container clearfix">
                ...
                <div class="pull-right">
					<ul class="bread-crumb clearfix">
						<li><a href="">Filtres à Huile</a></li>
						<!-- <li>Shop</li> -->
					</ul>
				</div>
            </div>
...
$sql = "SELECT  p.*, i.nom AS nom_image
        ...
        WHERE p.code_categorie = 201 AND p.code_type = 304 AND i.nom IS NOT NULL AND i.nom <> ''
        ";
    ...
    while ($row = $result->fetch_assoc()) {
		...
		<div class="shop-item col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="inner-box">
                ...
                <div class="image">
                    <img id='photo_prod'  src="images/filtreahuile/<?php echo $nom_image; ?>" alt="<?php echo $nom_produit; ?>"  />
